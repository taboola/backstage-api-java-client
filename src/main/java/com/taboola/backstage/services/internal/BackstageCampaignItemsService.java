...
public interface BackstageCampaignItemsService {
    ...
    Call<CampaignItem> createItem(@Header("Authorization") String accessToken,
                                              @Path("account_id") String accountId,
                                              @Path("campaign_id") String campaignId,
                                              @Body CampaignItem item);

    @GET(BackstagePaths.BACKSTAGE_API_PATH_PREFIX + "/{account_id}/campaigns/{campaign_id}/items")
    @Headers("Content-Type: application/json")
    Call<Results<CampaignItem>> readItems(@Header("Authorization") String accessToken,
                                          @Path("account_id") String accountId,
                                          @Path("campaign_id") String campaignId);

    @GET(BackstagePaths.BACKSTAGE_API_PATH_PREFIX + "/{account_id}/campaigns/{campaign_id}/items/{item_id}/children")
    @Headers("Content-Type: application/json")
    Call<Results<CampaignItem>> readRSSChildrenItems(@Header("Authorization") String accessToken,
                                                     @Path("account_id") String accountId,
                                                     @Path("campaign_id") String campaignId,
    ...
    @Headers("Content-Type: application/json")
    Call<CampaignItem> readSpecificRSSChildItem(@Header("Authorization") String accessToken,
                                                        @Path("account_id") String accountId,
                                                        @Path("campaign_id") String campaignId,
                                                        @Path("item_id") Long itemId,
    ...
    @Headers("Content-Type: application/json")
    Call<CampaignItem> updateSpecificRSSChildItem(@Header("Authorization") String accessToken,
                                                  @Path("account_id") String accountId,
                                                  @Path("campaign_id") String campaignId,
                                                  @Path("item_id") Long itemId,
                                                  @Path("child_id") Long childId,
                                                  @Body CampaignItem campaignItem);

    @GET(BackstagePaths.BACKSTAGE_API_PATH_PREFIX + "/{account_id}/campaigns/{campaign_id}/items/{item_id}")
    @Headers("Content-Type: application/json")
    Call<CampaignItem> readItem(@Header("Authorization") String accessToken,
                                 @Path("account_id") String accountId,
                                 @Path("campaign_id") String campaignId,
                                 @Path("item_id") Long itemId);
    ...
    @Headers("Content-Type: application/json")
    Call<CampaignItem> updateItem(@Header("Authorization") String accessToken,
                                   @Path("account_id") String accountId,
                                   @Path("campaign_id") String campaignId,
                                   @Path("item_id") Long itemId,
                                   @Body CampaignItem item);
    ...
    @Headers("Content-Type: application/json")
    Call<CampaignItem> deleteItem(@Header("Authorization") String accessToken,
                                  @Path("account_id") String accountId,
                                  @Path("campaign_id") String campaignId,
                                  @Path("item_id") Long itemId);
}
